...
mainScene.createPaddle = function() {
    ...
    this.physics.add.collider(this.paddle,this.ball,this.hitPaddle
    ,null,this);
};
...
mainScene.createBlocks = function() {
    // 横10列、縦6行並べる
    //ブロックの色の配列
    var blockColors=["red1","green1","yellow1","silver1","blue1",
    "purple1"];
    ...
    for(var i=0;i<6;i++){
        ...
        for(var j=0;j<10;j++){
            ...
            var block=this.blocks.create(80+j*64,80+i*32,
color);
            block.setOrigin(0,0);
